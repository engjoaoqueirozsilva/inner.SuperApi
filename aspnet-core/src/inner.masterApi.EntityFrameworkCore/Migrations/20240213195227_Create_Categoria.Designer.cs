...
namespace inner.masterApi.Migrations
{
    ...
    [Migration("20240213195227_Create_Categoria")]
    partial class Create_Categoria
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("inner.masterApi.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("inner.masterApi.Tarefa.Tarefa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("inner.masterApi.Treino.Treino", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Fundamento1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Fundamento2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Fundamento3")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Fundamento4")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Fundamento5")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Fundamento6")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("inner.masterApi.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("inner.masterApi.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("inner.masterApi.Authorization.Roles.Role", b =>
                {
                    b.HasOne("inner.masterApi.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("inner.masterApi.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("inner.masterApi.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
